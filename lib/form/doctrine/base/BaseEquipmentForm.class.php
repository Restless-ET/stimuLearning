...
abstract class BaseEquipmentForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'nature_or_purpose' => new sfValidatorChoice(array('choices' => array(0 => NULL, 1 => 'Building/Construction (1)', 2 => 'Copper cables (1)', 3 => 'Fiber cables (0.8)', 4 => 'Electronics (0.9)', 5 => 'Advanced Optical Components (0.7)', 6 => 'Passive Optical Components (0.8)'))),
      'valK'              => new sfValidatorNumber(array('required' => false)),
      'tecnology_age'     => new sfValidatorChoice(array('choices' => array(0 => NULL, 1 => 'Old (0.5)', 2 => 'Mature (0.1)', 3 => 'New (0.01)', 4 => 'Emerging (0.001)'))),
      'NrIni'             => new sfValidatorNumber(array('required' => false)),
      'setup_speed'       => new sfValidatorChoice(array('choices' => array(0 => NULL, 1 => 'Very fast (5)', 2 => 'Fast (10)', 3 => 'Slow (20)', 4 => 'Very slow (40)'))),
