...
/**
 * Tariff form base class.
 *
 * @method Tariff getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseTariffForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tariff[%s]');
