...
abstract class BaseEquipmentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'valK'              => new sfWidgetFormFilterInput(),
      ...
      'NrIni'             => new sfWidgetFormFilterInput(),
      ...
      'deltaT'            => new sfWidgetFormFilterInput(),
      'maximum_clients'   => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'valK'              => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      ...
      'NrIni'             => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      ...
      'deltaT'            => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'maximum_clients'   => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'architecture_id'   => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Architecture'), 'column' => 'id')),
      'operator_id'       => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Operator'), 'column' => 'id')),
