...
<?php if ($architecture->Operator->user_id == $sf_user->getAttribute('id') && !$architecture->Scenario->finished): ?>
  <?php echo $helper->linkToEdit($architecture, array(  'credentials' =>   array(    0 =>     array(      0 => 'admin',      1 => 'responsible',    ),  ),  'params' => 'class= fg-button ui-state-default ui-corner-all fg-button-icon-left ',  'class_suffix' => 'edit',  'label' => 'Edit',  'ui-icon' => '',)) ?>
