...
<?php if ($technology->Operator->user_id == $sf_user->getAttribute('id') && !$technology->Scenario->finished): ?>
  <?php echo $helper->linkToEdit($technology, array(  'credentials' =>   array(    0 =>     array(      0 => 'admin',      1 => 'responsible',    ),  ),  'params' => 'class= fg-button ui-state-default ui-corner-all fg-button-icon-left ',  'class_suffix' => 'edit',  'label' => 'Edit',  'ui-icon' => '',)) ?>
